    ...
    return (
        ...
        <div className="h-[100%]">
            <div className="h-[20%] flex items-center justify-between ">
                ...
                <button className="flex justify-between items-center ml-4 bg-gray-500 p-2 rounded-lg w-28 h-12 px-4">
                </button> 
            ...
            <div className="flex gap-x-5 items-center">
                ...
                <button onClick={clearUser} className="flex justify-between items-center ml-4 bg-red-500 p-2 rounded-lg w-28 h-12 px-4">
