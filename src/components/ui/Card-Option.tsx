...
export default function CardOption({title, description, icon, path}:{title:string, description:string, icon:any, path:string}){
    return(
        <Link href={path} className="w-[45%] md:w-[35%] h-[30vh] bg-white  hover:cursor-pointer  transform transition-transform duration-500 hover:scale-110 flex flex-col justify-center
