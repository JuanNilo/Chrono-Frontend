    ...
    return (
        <div className="h-[60vh] bg-slate-100">
            <div className="h-[100%] flex" >
                <aside className=" h-[100%] w-full  md:w-[50%]  flex flex-wrap justify-center p-12 gap-y-4">
                ...
                <main
                    className="hidden  md:flex flex-col  items-center justify-center h-[100%] w-[100%] bg-cover bg-center rounded-br-[50%] rounded-tl-[25%] drop-shadow-2xl"
